...
STUDIO_PACKAGE_URL=https://dl.google.com/dl/android/studio/ide-zips/3.0.0.8/android-studio-ide-171.4220116-linux.zip
...
sudo mv android-studio/ android-studio-preview/
sudo mkdir -p /opt
sudo mv android-studio-preview/ /opt
...
sh /opt/android-studio-preview/bin/studio.sh &
